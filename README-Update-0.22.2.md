# Franz Lernatelier – Update 0.22.2
...
- **Woche 38 · Übung 6:** Die Funktion **«Sprechkarte drucken»** ist wieder direkt in der Übung verfügbar.
- Die Karte ist als optionale Hilfe für die Generalprobe gedacht: **Vorderseite mit kompakten Stichwörtern**, **Rückseite mit dem vollständigen Text**.
- In Woche 38 verwendet die Rückseite beim Drucken jetzt ausdrücklich den **aktuell bearbeiteten Finaltext** aus «Mon texte final». Änderungen, Ergänzungen und Streichungen werden also mitgedruckt.
- Der editierbare Gesamttext, die Vorlesefunktion und die Partner-Generalprobe aus 0.22.1 bleiben unverändert erhalten.

## Bereits enthalten aus 0.22.1
...
Geprüft wurden unter anderem JavaScript-Syntax, Woche-38-Navigation, Ausschluss von Übung 4, editierbarer Finaltext, Wiederherstellungsfunktion, Vorlesen des bearbeiteten Textes, wiederhergestellte Druckfunktion inklusive bearbeitetem Finaltext, Stimmenwahl, Partnerprobe und Cache-Versionierung.
