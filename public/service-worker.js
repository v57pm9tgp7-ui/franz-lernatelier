const CACHE = 'franz-lernatelier-v0-17-ux';
const FILES = [
  './',
  './index.html',
  './assets/app.css',
  './assets/atelier.css?v=20260909-ux6',
  './assets/atelier-navigation.js?v=20260909-ux6',
  './assets/atelier-accessibility.js?v=20260909-ux6',
  './assets/app.js?v=20260909-ux6',
  './data/modules.js?v=20260909-ux6',
  './assets/app.js',
  './assets/cloud-account.js',
  './assets/cloud-sync.js',
  './assets/module-france.css',
  './assets/module-bridge.js?v=20260909-ux6',
  './assets/ui-workspace.css',
  './assets/ui-workspace.js?v=20260909-ux6',
