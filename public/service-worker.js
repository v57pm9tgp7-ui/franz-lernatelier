const CACHE = 'franz-lernatelier-v0-22-1-w38-final-text';
const FILES = [
  './',
  './index.html',
  './assets/app.css',
  ...
  './assets/atelier-accessibility.js?v=20260917-card7',
  './assets/week37-card-print-upgrade.js?v=20260917-card7',
  ...
  './assets/week38-module.js?v=20260917-w38-3',
