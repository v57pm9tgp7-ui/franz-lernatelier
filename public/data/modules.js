...
// Version 0.22.1 · Woche 38: kompletter editierbarer Text, Partnerprobe und Vorlesefunktion.
...
const FRANZ_MISSIONS_38 = FRANZ_MISSIONS_37
  ...
  .map(mission => {
    if (mission.id === 6) return {...mission,
      title:'Mon texte final',
      description:'Den vollständigen Text prüfen, direkt bearbeiten, anhören und für die Aufnahme üben.',
      time:'15–20 Min.',
      form:'Einzelarbeit'
    };
    if (mission.id === 7) return {...mission,
