...
// Version 0.19.4 · Woche 38 führt die Aufgaben aus Woche 37 weiter.
...
window.FRANZ_MODULES = [
  {
    id:'woche-36-2026',week:36,schoolYear:'2026/27',
  ...
  {
    id:'woche-37-2026',week:37,schoolYear:'2026/27',
  ...
  {
    id:'woche-38-2026',week:38,schoolYear:'2026/27',
    title:'Je continue',subtitle:'Qui suis-je ? · weiterarbeiten',
    description:'Keine neuen Aufgaben: Sie führen die acht Übungen aus Woche 37 weiter und schliessen offene Teile in Ihrem Tempo ab.',
    homeLead:'Woche 38 bringt vorläufig keine neuen Aufgaben. Ihr Stand aus Woche 37 ist übernommen. Sie sehen sofort, was bereits bearbeitet ist und wo Sie weiterarbeiten.',
    status:'current',continuationOf:'woche-37-2026',href:'module/woche-38/index.html',
    duration:'Weiterarbeit · individuell',missions:8,storageKey:'franzoesischLernatelierW37_v1',
    sharedProgressWith:'woche-37-2026',
    facts:['8 bekannte Übungen','Stand aus Woche 37 übernommen','Keine neuen Aufgaben'],
    tags:['Weiterarbeiten','Sprechen','Hören','Beruf'],
...
if (document.readyState === 'loading' && window.FRANZ_MODULES.some(m => m.week === 38 && m.status === 'current')) {
  document.write('<script src="assets/week38-home.js?v=20260913-w38-1"><\/script>');
}
